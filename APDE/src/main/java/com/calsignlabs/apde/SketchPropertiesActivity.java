...
public class SketchPropertiesActivity extends AppCompatActivity
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    fragment =
        (SketchPropertiesFragment)
            getSupportFragmentManager().findFragmentById(R.id.sketch_properties_fragment);
  ...
  public void copySketch() {
    // If we cannot write to the external storage (and the user wants to), make sure to inform the
    // user
    ...
    String sketchPath =
        getGlobalState().getSketchPath() + getResources().getString(R.string.copy_suffix);
    ...
    try {
      ...
      ((CodeEditText) getGlobalState().getEditor().findViewById(R.id.code))
