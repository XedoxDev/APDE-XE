...
public class SettingsActivity extends AppCompatActivity
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (savedInstanceState == null) {
      ...
      //				addHeadersFragment();
      //
      //				if (getSupportFragmentManager().findFragmentById(R.id.settings_fragment_container)
      // instanceof SettingsHeadersFragment) {
      //					addFirstSettingsFragment();
      //				}
  ...
  public void checkPreferences(PreferenceFragmentCompat frag) {
    ...
    if (hardwareKeyboard != null) {
      hardwareKeyboard.setOnPreferenceChangeListener(
          (preference, newValue) -> {
    ...
    if (vibrator != null) {
      ...
      if (!vibrate.hasVibrator())
        ((PreferenceCategory) frag.findPreference("pref_general_settings"))
            .removePreference(vibrator);
    }
    ...
    if (enableUndoRedo != null) {
      enableUndoRedo.setOnPreferenceChangeListener(
          (preference, newValue) -> {
    ...
    if (cleanBuild != null) {
      cleanBuild.setOnPreferenceClickListener(
          preference -> {
    ...
    if (previewReinstall != null && previewPermissions != null && previewUninstall != null) {
      previewReinstall.setOnPreferenceClickListener(
          preference -> {
            previewReinstall(new String[] {}, false, false);
            return true;
          });

      previewPermissions.setOnPreferenceClickListener(
          preference -> {
            launchPreviewPermissions();
            return true;
          });

      previewUninstall.setOnPreferenceClickListener(
          preference -> {
            previewUninstall();
            return true;
          });
    ...
    if (useOldAaptBinary != null) {
      ...
      // Disable the "Use pre-0.3.3 AAPT Binary" debug preference on devices that don't seem to have
      // these types of issues
      if (!(usePie && isArm)) {
        ((PreferenceCategory) frag.findPreference("pref_build_debug"))
            .removePreference(useOldAaptBinary);
      }
    }
    ...
    if (recopyAndroidJar != null) {
      recopyAndroidJar.setOnPreferenceClickListener(
          preference -> {
            ((APDE) getApplication())
                .getTaskManager()
    ...
    if (openBeta != null) {
      openBeta.setOnPreferenceClickListener(
          preference -> {
            launchOpenBeta();
    ...
    if (emailDev != null) {
      emailDev.setOnPreferenceClickListener(
          preference -> {
            launchEmailDev();
    ...
    if (updateExamplesNow != null) {
      updateExamplesNow.setOnPreferenceClickListener(
          preference -> {
    ...
    if (displayRecentChanges != null) {
      displayRecentChanges.setOnPreferenceClickListener(
          preference -> {
    ...
    if (sketchbookDrivePref != null) {
      ...
      sketchbookDrive.setValue(
          PreferenceManager.getDefaultSharedPreferences(SettingsActivity.this)
              .getString("pref_sketchbook_drive", ""));

      sketchbookDrive.init(
          R.layout.pref_sketchbook_drive_list_item,
          (view, position, entries) -> {
            LinearLayout layout = (LinearLayout) view;

            APDE.StorageDrive drive = drives.get(position);

            ((TextView) layout.findViewById(R.id.pref_sketchbook_drive_list_item_text_type))
                .setText(drive.type.title);
            ((TextView) layout.findViewById(R.id.pref_sketchbook_drive_list_item_text_space))
                .setText(drive.space);
            ((TextView) layout.findViewById(R.id.pref_sketchbook_drive_list_item_text_root))
                .setText(drive.root.getAbsolutePath());
          },
    ...
    if (codeTextSize != null) {
      codeTextSize.setOnBindEditTextListener(
          editText -> {
    ...
    if (consoleTextSize != null) {
      consoleTextSize.setOnBindEditTextListener(
          editText -> {
            editText.setInputType(InputType.TYPE_CLASS_NUMBER);
            editText.setMaxLines(1);
            editText.setSingleLine();
    ...
    if (sketchbookLocation != null) {
      sketchbookLocation.setOnBindEditTextListener(
          editText -> {
  ...
  protected void updateSketchbookDrivePref(
      ListPreference sketchbookDrive,
      Preference sketchbookLocation,
      ArrayList<APDE.StorageDrive> drives) {
    ...
    sketchbookLocation.setEnabled(
        !(selected.type.equals(APDE.StorageDrive.StorageDriveType.INTERNAL)
            || selected.type.equals(APDE.StorageDrive.StorageDriveType.SECONDARY_EXTERNAL)));
  ...
  protected void previewReinstall(
      String[] permissions, boolean replaceExisting, boolean forceSetPermissions) {
    ...
    global
        ...
        .launchTask(
            ...
            this,
            replaceExisting,
            new SketchPreviewerBuilder(
                global.getEditor(), permissions, false, forceSetPermissions));
  }
  ...
  protected void previewUninstall() {
    Intent uninstallIntent =
        new Intent(Intent.ACTION_DELETE, Uri.parse("package:com.calsignlabs.apde.sketchpreview"));
  ...
  protected void launchGitHub() {
    startActivity(
        new Intent(
            Intent.ACTION_VIEW,
            Uri.parse(getResources().getString(R.string.pref_about_github_uri))));
  }
  ...
  protected void launchOpenBeta() {
    startActivity(
        new Intent(
            Intent.ACTION_VIEW,
            Uri.parse(getResources().getString(R.string.pref_about_open_beta_uri))));
  }
  ...
  protected void launchEmailDev() {
    Intent emailIntent =
        new Intent(
            ...
            Uri.fromParts(
                "mailto", getResources().getString(R.string.pref_about_email_address), null));
    emailIntent.putExtra(
        Intent.EXTRA_SUBJECT, getResources().getString(R.string.pref_about_email_subject));
  ...
  protected static void launchDisplayRecentChanges(Activity activity) {
    ...
    layout =
        (RelativeLayout) LayoutInflater.from(activity).inflate(R.layout.whats_new, null, false);
    ...
    final ArrayAdapter<String> listAdapter =
        new ArrayAdapter<String>(
            activity, R.layout.whats_new_list_item, R.id.whats_new_list_item_text);
  ...
  protected void addHeadersFragment() {
    Fragment existingFragment =
        getSupportFragmentManager().findFragmentById(R.id.settings_fragment_container);

    SettingsHeadersFragment newFragment = new SettingsHeadersFragment();
    FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
    transaction.add(
        isMultiPane() ? R.id.settings_list_fragment_container : R.id.settings_fragment_container,
        newFragment);
  ...
  protected void addFirstSettingsFragment() {
    ...
    args.putString(
        "resource", getResources().getStringArray(R.array.settings_headers_fragments)[0]);
  ...
  public static class SettingsHeadersFragment extends Fragment {
    ...
    public void onStart() {
      ...
      final String[] headersFragments =
          getResources().getStringArray(R.array.settings_headers_fragments);
              ...
              new BaseAdapter() {
                ...
                public View getView(int position, View convertView, ViewGroup parent) {
                  if (convertView == null) {
                    ...
                    convertView =
                        inflater.inflate(R.layout.settings_headers_list_item, parent, false);
                  }
