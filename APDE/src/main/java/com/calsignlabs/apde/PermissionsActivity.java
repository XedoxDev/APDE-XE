...
public class PermissionsActivity extends AppCompatActivity {
  ...
  private void showPermissionDescDialog(final int perm) {
    // Inflate the layout
    LinearLayout layout =
        (LinearLayout) getLayoutInflater().inflate(R.layout.permission_desc_popup, null);

    // Populate the layout with permission values
    ((TextView) layout.findViewById(R.id.permission_desc_popup_title))
        .setText(Manifest.permissions.get(perm).name());
    ((TextView) layout.findViewById(R.id.permission_desc_popup_message))
        .setText(Manifest.permissions.get(perm).desc());

    // Create the alert
    MaterialAlertDialogBuilder build = new MaterialAlertDialogBuilder(this);
    ...
    if (Manifest.permissions.get(perm).custom()) {
      ((TextView) layout.findViewById(R.id.permission_desc_popup_message))
          .setVisibility(TextView.GONE); // TODO custom descriptions
      ...
      delete.setOnClickListener(
          new Button.OnClickListener() {
            @Override
            public void onClick(View view) {
              MaterialAlertDialogBuilder builder = new MaterialAlertDialogBuilder(PermissionsActivity.this);
  ...
  public void promptSaveDataPreviewSettings() {
    ...
    builder.setPositiveButton(
        R.string.pref_build_preview_permissions_reinstall_dialog_button_install,
        new DialogInterface.OnClickListener() {
          @Override
    ...
    builder.setNegativeButton(
        R.string.pref_build_preview_permissions_reinstall_dialog_button_exit,
        new DialogInterface.OnClickListener() {
          @Override
          public void onClick(DialogInterface dialogInterface, int i) {
            finish();
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    if (item.getItemId() == android.R.id.home) {
      ...
      return true;
    } else if (item.getItemId() == R.id.menu_new_permission) {
      newPermission();
      return true;
    ...
    build.setPositiveButton(
        ...
        new android.content.DialogInterface.OnClickListener() {
          ...
          public void onClick(
              ...
              int which) { // TODO let the user customize the prefix and the description
            String data = getData();

            Manifest.addCustomPermission(
                input.getText().toString(),
                getResources().getString(R.string.permissions_custom_perm),
