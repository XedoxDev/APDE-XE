...
public class ReferenceActivity extends AppCompatActivity {
  ...
  private String[] uris = {
    "http://processing.org/reference/", "http://android.processing.org/reference/"
  };
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    final CharSequence[] titles = {
      getResources().getString(R.string.reference_source_processing),
      getResources().getString(R.string.reference_source_android_processing)
    };

    ArrayAdapter<CharSequence> adapter =
        new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, Arrays.asList(titles));
    ...
    referenceSource.setOnItemSelectedListener(
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    if (item.getItemId() == android.R.id.home) {
      finish();
      return true;
    } else if (item.getItemId() == R.id.action_open_uri_external) {
      openUriExternal();
      return true;
