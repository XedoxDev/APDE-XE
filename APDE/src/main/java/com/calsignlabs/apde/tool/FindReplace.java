...
public class FindReplace implements Tool {
  ...
  public static enum Direction implements FlattenableEnum<Direction> {
    ...
    public Direction fromString(String value) {
      if (value.equals("forward")) return FORWARD;
      if (value.equals("backward")) return BACKWARD;
  ...
  public static enum Scope implements FlattenableEnum<Scope> {
    ...
    public Scope fromString(String value) {
      ...
      if (value.equals("currentTab")) return CURRENT_TAB;
  ...
  public static class MutableFlattenableEnum<E extends FlattenableEnum<E>> {
    ...
    public static <E extends FlattenableEnum<E>> MutableFlattenableEnum<E> fromString(
        E inst, String value) {
            ...
            new Runnable() {
              public void run() {
                ...
                if (context.isExample()) {
                  findReplaceToolbar =
                      (LinearLayout)
                          LayoutInflater.from(context).inflate(R.layout.find_toolbar, null, false);
                } else {
                  findReplaceToolbar =
                      (LinearLayout)
                          LayoutInflater.from(context)
                              .inflate(R.layout.find_replace_toolbar, null, false);
                }

                options =
                    (ScrollView)
                        LayoutInflater.from(context).inflate(
                            R.layout.find_replace_options,
                            null, false);
                ...
                // For some reason removing the posted runnable fixes the problem.
                {
                  ...
                  findReplaceToolbar.startAnimation(
                  ...
                  if (codePager.getHeight() >= height) {
                    ...
                    resizeConsole =
                        new ResizeAnimation<>(
                            ...
                            ResizeAnimation.DEFAULT,
                            LinearLayout.LayoutParams.MATCH_PARENT,
                            console.getHeight() - (height - codePager.getHeight()),
                            false);
                  }
                ...
                final RelativeLayout replaceBar =
                    (RelativeLayout) findReplaceToolbar.findViewById(R.id.find_replace_replace_bar);
                // Not visible by default
                replaceBar.setVisibility(View.GONE);

                ImageButton closeButton =
                    (ImageButton) findReplaceToolbar.findViewById(R.id.find_replace_close);
                final ImageButton expandCollapseButton =
                    (ImageButton)
                        findReplaceToolbar.findViewById(R.id.find_replace_expand_collapse);
                ImageButton moreOptions =
                    (ImageButton) findReplaceToolbar.findViewById(R.id.find_replace_more_options);

                findButton = (ImageButton) findReplaceToolbar.findViewById(R.id.find_replace_find);
                replaceButton =
                    (ImageButton) findReplaceToolbar.findViewById(R.id.find_replace_replace);
                replaceAllButton =
                    (ImageButton) findReplaceToolbar.findViewById(R.id.find_replace_all);

                findTextField =
                    (EditText) findReplaceToolbar.findViewById(R.id.find_replace_find_text);
                replaceTextField =
                    (EditText) findReplaceToolbar.findViewById(R.id.find_replace_replace_text);

                RadioButton directionForward =
                    (RadioButton) options.findViewById(R.id.find_replace_options_direction_forward);
                RadioButton directionBackward =
                    (RadioButton)
                        options.findViewById(R.id.find_replace_options_direction_backward);

                RadioButton scopeSelection =
                    (RadioButton) options.findViewById(R.id.find_replace_options_scope_selection);
                RadioButton scopeCurrentTab =
                    (RadioButton) options.findViewById(R.id.find_replace_options_scope_current_tab);
                RadioButton scopeAllTabs =
                    (RadioButton) options.findViewById(R.id.find_replace_options_scope_all_tabs);

                // TODO Selection scope isn't currently implemented... too many issues
                scopeSelection.setVisibility(View.GONE);

                SwitchCompat highlightAllCheckBox =
                    (SwitchCompat) options.findViewById(R.id.find_replace_options_highlight_all);
                SwitchCompat wrapAroundCheckBox =
                    (SwitchCompat) options.findViewById(R.id.find_replace_options_wrap_around);
                SwitchCompat caseSensitiveCheckBox =
                    (SwitchCompat) options.findViewById(R.id.find_replace_options_case_sensitive);
                SwitchCompat regExpCheckBox =
                    (SwitchCompat) options.findViewById(R.id.find_replace_options_reg_exp);

                // TODO Regular Expressions aren't currently implemented
                options
                    .findViewById(R.id.find_replace_options_reg_exp_container)
                    .setVisibility(View.GONE);

                context.assignLongPressDescription(findButton, R.string.tool_find_replace_find);
                context.assignLongPressDescription(
                    replaceButton, R.string.tool_find_replace_replace_and_find);
                context.assignLongPressDescription(
                    replaceAllButton, R.string.tool_find_replace_replace_all);

                context.assignLongPressDescription(closeButton, R.string.tool_find_replace_close);
                context.assignLongPressDescription(
                    expandCollapseButton, R.string.tool_find_replace_expand);

                assignEnumRadioGroup(
                    context,
                    "direction",
                    0,
                    new RadioButton[] {directionForward, directionBackward},
                    new Direction[] {Direction.FORWARD, Direction.BACKWARD},
                    direction);
                assignEnumRadioGroup(
                    context,
                    "scope",
                    1,
                    new RadioButton[] {scopeSelection, scopeCurrentTab, scopeAllTabs},
                    new Scope[] {Scope.SELECTION, Scope.CURRENT_TAB, Scope.ALL_TABS},
                    scope);
                ...
                assignBooleanSwitch(
                    context, "wrap_around", true, wrapAroundCheckBox, wrapAround, null);
                assignBooleanSwitch(
                    context,
                    "case_sensitive",
                    false,
                ...
                expandCollapseButton.setOnClickListener(
                    new ImageButton.OnClickListener() {
                      ...
                      public void onClick(View v) {
                        ...
                        if (findReplaceToolbar.getHeight() != height
                            && findReplaceToolbar.getHeight() != height * 2) {
                        ...
                        if (replaceBar.getVisibility() == View.GONE) {
                          ...
                          context.assignLongPressDescription(
                              expandCollapseButton, R.string.tool_find_replace_collapse);
                          ...
                          ResizeAnimation<LinearLayout> resize =
                              new ResizeAnimation<LinearLayout>(
                                  findReplaceToolbar,
                                  LinearLayout.LayoutParams.MATCH_PARENT,
                                  height * 2,
                ...
                findTextField.addTextChangedListener(
                    new TextWatcher() {
                      @Override
                ...
                replaceAllButton.setOnClickListener(
                    new View.OnClickListener() {
                      ...
                      public void onClick(View v) {
                        replaceAll(
                            findTextField.getText().toString(),
                            replaceTextField.getText().toString());
                      }
                    });
    ...
    if (findReplaceToolbar != null) {
      ...
      codePager.startAnimation(
          new ResizeAnimation<LinearLayout>(
              ...
              ResizeAnimation.DEFAULT,
              LinearLayout.LayoutParams.MATCH_PARENT,
              codePager.getHeight() + findReplaceToolbar.getHeight()));
    }
  }

  protected void assignBooleanSwitch(
      final APDE context,
      final String key,
      final boolean defaultValue,
      final SwitchCompat switchCompat,
      final MutableBoolean value,
  ...
  protected <E extends FlattenableEnum<E>> void assignEnumRadioGroup(
      final APDE context,
      final String key,
      final int defaultValue,
      final RadioButton[] radioButtons,
      final E[] radioButtonValues,
      final MutableFlattenableEnum<E> value) {
    ...
    MutableFlattenableEnum<E> savedValue =
        MutableFlattenableEnum.fromString(
            radioButtonValues[0],
            getPreferences(context).getString(key, radioButtonValues[defaultValue].toString()));
    ...
    for (int i = 0; i < radioButtons.length; i++) {
      ...
      radioButtons[i].setOnCheckedChangeListener(
          new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
              if (isChecked) {
    ...
    switch (scope.get()) {
      case SELECTION:
        ...
        String selectionText =
            context.getCodeArea().getText().toString().substring(selectionStart, selectionEnd);

        findMatches =
            findMatches(
                (caseSensitive.get() ? token : token.toLowerCase()),
                (caseSensitive.get() ? selectionText : selectionText.toLowerCase()),
                context.getEditor().getSelectedCodeIndex(),
                selectionStart);
      ...
      case CURRENT_TAB:
        ...
        findMatches =
            findMatches(
                (caseSensitive.get() ? token : token.toLowerCase()),
                (caseSensitive.get() ? currentTabText : currentTabText.toLowerCase()),
                context.getEditor().getSelectedCodeIndex(),
                0);
      ...
      case ALL_TABS:
        ...
        for (int i = 0; i < context.getEditor().getCodeCount(); i++) {
          ...
          findMatches.addAll(
              findMatches(
                  (caseSensitive.get() ? token : token.toLowerCase()),
                  (caseSensitive.get() ? tabText : tabText.toLowerCase()),
                  i,
                  0));
        }
            ...
            new Runnable() {
              ...
              public void run() {
                if (findMatches.size() == 0) {
                  findTextField.setTextColor(
                      context.getResources().getColor(R.color.find_replace_find_not_found));
                } else {
                  findTextField.setTextColor(
  ...
  public void findOne(String token, boolean advance) {
    ...
    int currentPos =
        forward
            ? (advance ? selectionEnd : selectionStart)
            : (advance ? selectionStart : selectionEnd);
    ...
    switch (scope.get()) {
      ...
      case ALL_TABS:
        ...
        findMatch =
            findFirstMatch(
                caseToken,
                (caseSensitive.get() ? currentTabTextAll : currentTabTextAll.toLowerCase()),
                currentTab,
                0,
                currentPos);

        if (findMatch == null) {
          for (int i = currentTab + (forward ? 1 : -1);
              (forward ? i < tabCount : i >= 0);
              i += (forward ? 1 : -1)) {
            String tabText = context.getEditor().getTabMetas()[i].getText();

            findMatch =
                findFirstMatch(
                    caseToken, (caseSensitive.get() ? tabText : tabText.toLowerCase()), i, 0, 0);
        ...
        if (findMatch == null) {
          for (int i = (forward ? 0 : tabCount - 1);
              (forward ? i < currentTab : i > currentTab);
              i += (forward ? 1 : -1)) {
            String tabText = context.getEditor().getTabMetas()[i].getText();
  ...
  public void addHighlights() {
    ...
    for (FindMatch findMatch : findMatches) {
      if (findMatch.tabNum == context.getEditor().getSelectedCodeIndex()) {
        context
            .getCodeArea()
            .addHighlight(findMatch.position, findMatch.tokenLength, highlightAllPaint);
      }
    }
  ...
  public void nextFindMatch() {
    ...
    int nextFindMatch =
        indexOfTextPos(
            context.getEditor().getSelectedCodeIndex(),
            forward
                ? context.getCodeArea().getSelectionEnd()
                : context.getCodeArea().getSelectionStart(),
            forward);

    if (nextFindMatch == -1 && scope.get().equals(Scope.ALL_TABS)) {
      for (int i = context.getEditor().getSelectedCodeIndex() + (forward ? 1 : -1);
          (forward ? i < context.getEditor().getCodeCount() : i >= 0);
          i += (forward ? 1 : -1)) {
        int matchIndex =
            indexOfTextPos(
                i,
                (forward ? 0 : context.getEditor().getTabMetas()[i].getText().length() - 1),
                forward);
      ...
      if (nextFindMatch == -1 && wrapAround.get()) {
        for (int i = (forward ? 0 : context.getEditor().getCodeCount() - 1);
            (forward
                ? i <= context.getEditor().getSelectedCodeIndex()
                : i >= context.getEditor().getSelectedCodeIndex());
            i += (forward ? 1 : -1)) {
          int matchIndex =
              indexOfTextPos(
  ...
  public void selectCursorFindMatch(int offset) {
    ...
    int cursorFindMatch =
        indexOfTextPos(
            context.getEditor().getSelectedCodeIndex(),
            forward
                ? context.getCodeArea().getSelectionStart() + offset
                : context.getCodeArea().getSelectionEnd() - offset,
            forward);
  ...
  protected int indexOfTextPos(int tabNum, int textPos, boolean forward) {
    for (int i = (forward ? 0 : findMatches.size() - 1);
        forward ? (i < findMatches.size()) : (i >= 0);
        i += (forward ? 1 : -1)) {
      FindMatch findMatch = findMatches.get(i);

      if (findMatch.tabNum == tabNum
          && (forward ? findMatch.position >= textPos : findMatch.position < textPos)) {
        return i;
      }
    }
  ...
  public int getCurrentFindEnd() {
    return lastFindMatch != null
        ? lastFindMatch.textOffset + lastFindMatch.position + lastFindMatch.tokenLength
        : 0;
  }
  ...
  public FindMatch findFirstMatch(
      String token, String text, int tabNum, int textOffset, int startAt) {
  ...
  public void replace(FindMatch findMatch, String replace) {
    ...
    context
        .getCodeArea()
        .getText()
        .replace(findMatch.position, findMatch.position + findMatch.tokenLength, replace);
  }
              ...
              public void run() {
                ...
                switch (scope.get()) {
                  case SELECTION:
                    ...
                    //					int selectionEnd = context.getCodeArea().getSelectionEnd();
                    //
                    //					Editable selectionText =
                    // Editable.Factory.getInstance().newEditable(context.getCodeArea().getText().toString().substring(selectionStart, selectionEnd));
                    //
                    //					while (true) {
                    //						FindMatch selectionFindMatch = findFirstMatch(find,
                    // selectionText.toString(), context.getEditor().getSelectedCodeIndex(),
                    // selectionStart);
                    //
                    ...
                    //						}
                    //
                    //						context.getCodeArea().getText().replace(selectionFindMatch.position,
                    // selectionFindMatch.position + selectionFindMatch.tokenLength, replace);
                    //						count ++;
                    //					}
                    ...
                    break;
                  case CURRENT_TAB:
                    Editable currentTabText =
                        Editable.Factory.getInstance().newEditable(context.getCodeArea().getText());
                    ...
                    while (true) {
                      ...
                      currentTabText.replace(
                          currentTabFindMatch.position,
                          currentTabFindMatch.position + currentTabFindMatch.tokenLength,
                          replace);
                  ...
                  case ALL_TABS:
                      ...
                      if (i == context.getEditor().getSelectedCodeIndex()) {
                        tabTexts[i] =
                            Editable.Factory.getInstance()
                                .newEditable(context.getCodeArea().getText());
                      } else {
                        tabTexts[i] =
                            Editable.Factory.getInstance()
                                .newEditable(context.getEditor().getTabMetas()[i].getText());
                      }
                    }
                    ...
                    while (true) {
                      tabFindMatch =
                          findFirstMatch(find, tabTexts[tabNum].toString(), tabNum, 0, pos);
                      ...
                      tabTexts[tabNum].replace(
                          tabFindMatch.position,
                          tabFindMatch.position + tabFindMatch.tokenLength,
                          replace);
                            ...
                            if (scope.get().equals(Scope.ALL_TABS)) {
                              ...
                              for (int i = 0; i < finalOutputTexts.length; i++) {
                                if (i == context.getEditor().getSelectedCodeIndex()) {
                                  context
                                      .getCodeArea()
                                      .setUpdateText(finalOutputTexts[i].toString());
                                } else {
                                  ...
                                  if (PreferenceManager.getDefaultSharedPreferences(context)
                                    ...
                                    sketchFile.update(
                                        context.getEditor(),
                                        getFileChange(sketchFile, finalOutputTexts[i]));
                                  }

                                  // With the new ViewPager as part of Material design, the two tabs
                                  // adjacent
                                  // to the current tab are kept loaded, so we need to force them to
                                  // update
                            ...
                            postStatus(
                                String.format(
                                    ...
                                    context
                                        .getResources()
                                        .getQuantityString(
                                            R.plurals.find_replace_replace_all_complete,
                                            finalCount),
                                    finalCount));
